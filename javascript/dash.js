                    ...
                    <div class="other__profile">
                        ...
                        <div class="extsidebar__footerbar__profile__display">
                            ...
                            <div class="extsidebar__footerbar__profile__left__text marginleft">
                                <div class="extsidebar__footerbar__profile__left__namedisplay">YAGPDB.xyz</div>
                                <div class="extsidebar__footerbar__profile__left__activedisplsy">learning node</div>
                            </div>
                        </div>
...
`;
  ...
  for (let n = 0; n < chanelinfo.length; n++) {
    ...
    <div class="chat">
        ...
        <div class="chat__msg__p">This is the start of the #dicord-clone channel.</div>
    </div>
